...
export default function EditJob() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const resultAction = await dispatch(updateJob({ jobId, updates: updateData }));
      ...
      if (updateJob.fulfilled.match(resultAction)) {
        ...
        const errorMessage = resultAction.payload as string || "Failed to update job";
              ...
              >
                {isSubmitting || loading ? (
                  <>
                    ...
                    {step === steps.length - 1 ? "Updating..." : "Processing..."}
                  </>
                ) : (
                  <>
