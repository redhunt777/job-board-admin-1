...
const [viewMode, setViewMode] = useState("board"); // 'board' or 'list'
  ...
  return (
    <main
      className={`transition-all duration-300 min-h-screen pb-40 md:pb-0 px-0 ${
    ...
    >
      ...
      <div className="mt-4 px-4 md:px-8 pt-4 ">
        <div className="flex items-center gap-2 font-medium">
          <span>
            <FiArrowLeftCircle className="text-[#606167] text-2xl cursor-pointer hover:text-[#4B5563] transition-all duration-300" />
          </span>
          <span className="text-[#606167] text-sm">Back to Dashboard</span>
          <span className="text-[#151515]"> / Jobs</span>
        </div>
        ...
        <div className="flex items-center justify-between mb-4">
          {/* <div className="flex item-center justify-center gap-2">
            <button className="flex items-center gap-2 cursor-pointer bg-[#1E5CDC] text-[#FFFFFF] px-4 py-2 rounded-3xl hover:bg-[#1A4BB0] text-sm transition-colors">
              <span>
                <svg
                  width="24"
                  height="24"
            ...
            <button className="flex items-center gap-2 cursor-pointer text-[#606167] hover:text-[#4B5563] text-sm transition-colors border border-[#6066167] px-4 py-2 rounded-3xl">
              <span>
